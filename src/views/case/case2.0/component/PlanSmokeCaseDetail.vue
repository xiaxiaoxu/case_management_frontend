<template>
  <div ref="smokeCaseDetailModal">
    <a-modal
      :width="'80%'"
      :getContainer="() => $refs.smokeCaseDetailModal"
      style="top: 20px;"
      v-model="visible"
      @ok="handleOk"
      @cancel="handleCancel"
                ...
                <a-row :gutter="4">
                  ...
                  <a-col :md="14" :lg="7" style="margin-top: 5px; margin-left: 10px;">
                    ...
                    <a-popover v-model="item.set_step_execute_result_visible" trigger="click" placement="bottomRight" :auto-adjust-overflow="true">
                      ...
                      <a-icon type="down" :style="{ marginLeft: '15px', fontSize: '20px' }"/>
                    </a-popover>
                  </a-col>
                </a-row>
...
import { planSmokeCaseDetailSetExecuteResult, getPlanCaseDetail } from '@/api/case/case_two'
...
export default {
  ...
  components: { CaseExecuteCommentEditor },
  data () {
    return {
      id: 0,
      keysList: [1],
  ...
  methods: {
    ...
    goToPreviousCase () {
      ...
      this.init(previouseCase, this.project_name)
    },
    goToNextCase () {
    ...
    handleExecuteResult () {
      ...
      console.log('params in handleExecuteResult:')
      console.log(params)
      planSmokeCaseDetailSetExecuteResult(params).then(res => {

      ...
      <div class="table-page-search-wrapper">
        <div style="height: 160px;">
          ...
          <div style="margin-top: 15px; height: 30px; width: 100%; background-color: #F5F5F5">
            ...
            <span style="margin-left: 5px; cursor:pointer;" @click="setPlanCaseExecutorMyself()">{{ this.userNameCn }}</span>
...
<script>
import { setPlanCaseExecutor } from '@/api/case/case_two'
...
export default {
  ...
  methods: {
    handleChange (value) {
      ...
      setPlanCaseExecutor(params).then(res => {
    ...
    setPlanCaseExecutorMyself () {
      console.log('in setPlanCaseExecutorMyself')
      const params = {
        plan_case_id_list: this.plan_case_id_list,
        executor: this.userNameCn
      }
      console.log('params in setPlanCaseExecutorMyself:', params)
      setPlanCaseExecutor(params).then(res => {
